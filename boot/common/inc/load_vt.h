...
#define VENDOR_KERNEL_BOOT_NAME "vendor_kernel_boot"
#else
...
#define VENDOR_KERNEL_BOOT_A_NAME "vendor_kernel_boot_a"
#define VENDOR_KERNEL_BOOT_B_NAME "vendor_kernel_boot_b"
