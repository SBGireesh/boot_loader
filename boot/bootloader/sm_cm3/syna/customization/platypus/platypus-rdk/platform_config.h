...
// U9, FLX6408, ADDR = 0. I2C 7-bit address: 0x43
// TW3, GPIO0_1, VCORE_ON#, active low.
// TW3, GPIO0_0, VCPU_ON#, active low.
// TW3, GPIO0_2, VDDM_ON#, active low.

// U10, FLX6408, ADDR = 1. I2C 7-bit address: 0x44
// TW3, GPIO1_7, STAND-BY_EN, active high.
// TW3, GPIO1_3, WL_REG_ON#, active low.

/* Power pins definitions*/
#define I2C_MASTER_ID 	1
#define I2C_SLAVE0_ADDR 	0x43
#define I2C_SLAVE1_ADDR 	0x44

/* I2C expander GPIO0 */
#define GPIO_VCPU_VCORE    0
#define VCPU_VCORE_ON      0
#define VCPU_VCORE_OFF     1
...
/* SM_GPIO7 is shared between WiFi BT and PCIe*/
#define SM_GPIO_PORT_WIFIBT   7
/* There is no GEPHY in VS640*/
