...
int diag_config_pll_vco(unsigned int pllbase, int refdiv, int fddiv,
			unsigned int frac)
{
	int ret=0;
...
int diag_config_pll_ssc(unsigned int pllbase, int ssc_freq, int ssc_amp,
			int ssc_mode, int enable)
{
