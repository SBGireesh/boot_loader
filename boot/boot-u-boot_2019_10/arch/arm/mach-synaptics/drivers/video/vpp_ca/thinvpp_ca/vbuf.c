...
void build_frames(VBUF_INFO *vbufinfo, INT32 srcfmt, INT32 bit_depth, INT32 x,
		  INT32 y, INT32 width, INT32 height, INT32 progressive,
		  INT32 pattern_type,bool IsPatt)
{
    UINT32 datasize = 1;
    INT32 bit_frac = 1;
    ...
    vbufinfo->m_right_eye_view_buf_start = (ARCH_PTR_TYPE)NULL;
    vbufinfo->m_right_eye_view_descriptor = (ARCH_PTR_TYPE)NULL;
